...
<br><tr><td><input type="text" class="form-control" name="cat" value=<?php echo $r[2];?>></td>
	...
	<td><Button>delete</Button></td></form>
						...
						<form method="post" action="block.php">
 								...
 								<input type="hidden" name="code" value="<?php echo $r[1] ; ?>" >
	<td><Button id="r<?php echo $r[0];?>">block</Button></td></form></tr>
		...
		<?php			
$rs=mysql_query("select * from cat where code!='$code' AND status=0");
