...
<div class="navbar-header" >
 ...
 <ul class="nav navbar-nav">
        <li class="active"  style="color:white"><a href="ques1.php">question</a></li>
...
echo $r[8];
	...
	while($p=mysql_fetch_array($pq)){
	$code=$p[2];
$rs=mysql_query("select * from que where code='$code' and status=1");
	if($r=mysql_fetch_array($rs)){
            ?>
...
<a href="showque.php?code=<?php echo $r[2] ; ?>"><?php echo $r[3] ; ?></a><br>  
