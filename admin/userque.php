...
<a href="userans.php?email=<?php echo $g[3] ; ?>" class="list-group-item list-group-item-action">user answers</a>
<a href="userque.php?email=<?php echo $g[3] ; ?>" class="list-group-item list-group-item-action  active">user questions</a>
...
<?php echo $r[11] ; ?>  </a>
		...
		<Button style=" float:right;"><a href="blockque.php?code=<?php echo $r[2] ; ?>" style=" text-decoration:none">block</a></Button><br>
...
<?php
	...
	$rs=mysql_query("select * from que where email='$email' AND status=1");
	while($r=mysql_fetch_array($rs)){
...
<?php echo $r[11] ; ?>  </a>
		...
		<Button style=" float:right;"><a href="unblockque.php?code=<?php echo $r[2] ; ?>" style=" text-decoration:none">unblock</a></Button><br>
