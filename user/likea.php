<?php
	...
	mysql_select_db("overflow");
		...
		$rs=mysql_query("select * from likeunlikea where acode='$acode' AND email= '$email' AND likea=1")or die(mysql_error());
		...
		if($r=mysql_fetch_array($rs)){
			mysql_query("update likeunlikea set likea=1 where acode='$acode' AND email='$email'")or die(mysql_error());
