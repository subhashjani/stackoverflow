...
<a class="active" href="topque.php">top questions</a>
...
<div class="col-sm-12">
<div class="col-sm-4">
	<a href="like.php?code=<?php echo $r[2] ; ?>&flag9=1"><li class="glyphicon glyphicon-thumbs-up" style=" color:#595959"></li></a>
...
$code=$r[2];
	...
	$xy=mysql_num_rows($pq);
?>
	<a href="unlikeque.php?code=<?php echo $r[2] ; ?>&flag9=1"><li class="glyphicon glyphicon-thumbs-down" style=" color:#595959"></li></a>
