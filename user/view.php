...
<a class="active" href="view.php">Most viewed questions</a>
<?php
...
<div class="col-sm-8" style="height:650px; overflow:scroll ">

<?php
mysql_connect("localhost","root","");
	mysql_select_db("overflow");
	
$rs=mysql_query("select * from que where view > 1 AND status=0");
...
<div class="col-sm-12">
<div class="col-sm-4">
	<a href="like.php?code=<?php echo $r[2] ; ?>&flag10=1"><li class="glyphicon glyphicon-thumbs-up" style=" color:#595959"></li></a>
...
$code=$r[2];
	...
	$xy=mysql_num_rows($pq);
?>
	<a href="unlikeque.php?code=<?php echo $r[2] ; ?>&flag10=1"><li class="glyphicon glyphicon-thumbs-down" style=" color:#595959"></li></a>
...
<a href="#"><img src="ad6.jpg"  class="img-responsive "></a><br><br>
<a href="#"><img src="ad5.jpg"  class="img-responsive "></a>
 </div>
</div>
  </div>
  </div>
