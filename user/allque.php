...
<div class="navbar-header" >
 ...
 <ul class="nav navbar-nav">
        <li class="active"  style="color:white"><a href="allque.php">all-question</a></li>
...
<div class="col-sm-7 " style="margin-top:60">
...
<div class="col-sm-12">
<div class="col-sm-4">
	<a href="like.php?code=<?php echo $r[2] ; ?>&flag3=1"><li class="glyphicon glyphicon-thumbs-up" style=" color:#595959"></li></a>
...
$code=$r[2];
	...
	$xy=mysql_num_rows($pq);
?>
	<a href="unlikeque.php?code=<?php echo $r[2] ; ?>&flag3=1"><li class="glyphicon glyphicon-thumbs-down" style=" color:#595959"></li></a>
