...
<div class="col-sm-8" style="margin-top:55px">

<?php
mysql_connect("localhost","root","");
	mysql_select_db("overflow");
	$code=$_GET["code"];
	$ac=mysql_query("select * from qcat where code='$code'");
...
<div class="col-sm-12">
<div class="col-sm-4">
	<a href="like.php?code=<?php echo $r[2] ; ?>&flag8=1&ccode=<?php echo $a[3] ; ?>"><li class="glyphicon glyphicon-thumbs-up" style=" color:#595959"></li></a>
...
$code=$r[2];
	...
	$xy=mysql_num_rows($pq);
?>
	<a href="unlikeque.php?code=<?php echo $r[2] ; ?>&flag8=1&ccode=<?php echo $a[3] ; ?>"><li class="glyphicon glyphicon-thumbs-down" style=" color:#595959"></li></a>
